...
type UseragentParserSDK struct {
	Mode     string
...
func (sdk *UseragentParserSDK) OptionsMap() map[string]any {
...
func (sdk *UseragentParserSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *UseragentParserSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *UseragentParserSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UseragentParserSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *UseragentParserSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *UseragentParserSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("UseragentParserSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *UseragentParserSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UseragentParserSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("UseragentParserSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *UseragentParserSDK {
	...
	sdk := NewUseragentParserSDK(sdkopts)
	sdk.Mode = "test"
