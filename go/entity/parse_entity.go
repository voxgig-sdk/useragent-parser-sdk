...
type ParseEntity struct {
	name    string
	client  *core.UseragentParserSDK
...
func NewParseEntity(client *core.UseragentParserSDK, entopts map[string]any) *ParseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ParseEntity) GetName() string { return e.name }
...
func (e *ParseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ParseEntity) Deleted() bool {
	return e.deleted
}


func (e *ParseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewParseEntity(e.client, opts)
}

func (e *ParseEntity) Data(args ...any) any {
...
func (e *ParseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Parse; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ParseEntity) DataTyped(data ...Parse) Parse {
	if len(data) > 0 {
		return typedFrom[Parse](e.Data(asMap(data[0])))
	}
	return typedFrom[Parse](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Parse (all fields
// optional at the wire level).
func (e *ParseEntity) MatchTyped(match ...Parse) Parse {
	if len(match) > 0 {
		return typedFrom[Parse](e.Match(asMap(match[0])))
	}
	return typedFrom[Parse](e.Match())
}
...
func (e *ParseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ParseEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ParseLoadMatch and returns an Parse. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ParseEntity) LoadTyped(reqmatch ParseLoadMatch, ctrl map[string]any) (Parse, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Parse{}, err
	}
	return typedFrom[Parse](res), nil
}



func (e *ParseEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ParseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ParseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ParseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ParseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
