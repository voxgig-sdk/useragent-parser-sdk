...
// instead of `sdk.NewUseragentParserSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *UseragentParserSDK  { return NewUseragentParserSDK(nil) }
func Test() *UseragentParserSDK { return TestSDK(nil, nil) }
