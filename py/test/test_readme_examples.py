# UseragentParser SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UseragentParserSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UseragentParserSDK(...) and UseragentParserSDK.test(...) become
#      UseragentParserSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "useragentparser_sdk"
_SDK_CLASS = "UseragentParserSDK"
