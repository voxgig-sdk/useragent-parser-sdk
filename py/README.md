# UseragentParser Python SDK



The Python SDK for the UseragentParser API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Parse()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/useragent-parser-sdk/releases)) or
...
```python
client = UseragentParserSDK.test(testopts, sdkopts)
```
...
```
py/
├── useragentparser_sdk.py         -- Main SDK module
...
The main module (`useragentparser_sdk`) exports the SDK class.
