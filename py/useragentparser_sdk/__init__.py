...
from useragentparser_sdk.utility import register

# Load features
from useragentparser_sdk.feature.base_feature import UseragentParserBaseFeature
from useragentparser_sdk.features import _has_feature, _make_feature
...
class UseragentParserSDK:
    ...
    def get_utility(self):
        return UseragentParserUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UseragentParserSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Parse(self, data=None) -> "ParseEntity":
        ...
        from useragentparser_sdk.entity.parse_entity import ParseEntity
