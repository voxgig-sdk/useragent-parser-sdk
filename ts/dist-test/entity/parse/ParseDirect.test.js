...
(0, node_test_1.describe)('ParseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.UseragentParserSDK({
    ...
    (0, node_test_1.test)('direct-load-parse', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-parse', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.USERAGENT_PARSER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UseragentParserSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.USERAGENT_PARSER_APIKEY,
        }));
        let idmap = env['USERAGENT_PARSER_TEST_PARSE_ENTID'];
    ...
    const client = new __1.UseragentParserSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ParseDirect.test.js.map