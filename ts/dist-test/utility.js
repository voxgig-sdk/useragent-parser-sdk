...
function envOverride(m) {
    if ('TRUE' === process.env.USERAGENT_PARSER_TEST_LIVE ||
        'TRUE' === process.env.USERAGENT_PARSER_TEST_OVERRIDE) {
    ...
    m.USERAGENT_PARSER_TEST_EXPLAIN = process.env.USERAGENT_PARSER_TEST_EXPLAIN || m.USERAGENT_PARSER_TEST_EXPLAIN;
    return m;
}
