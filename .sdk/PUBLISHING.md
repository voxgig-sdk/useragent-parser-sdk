...
|---|---|---|
| `ts/` | @voxgig-sdk/useragent-parser-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/useragent-parser-sdk \
      --repository voxgig-sdk/useragent-parser-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/useragent-parser-sdk` shows it, and
`npm trust revoke @voxgig-sdk/useragent-parser-sdk --id=<id>` removes it.
