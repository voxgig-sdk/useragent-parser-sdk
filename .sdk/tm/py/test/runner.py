...
class UseragentParserTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UseragentParserTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UseragentParserTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UseragentParserTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
