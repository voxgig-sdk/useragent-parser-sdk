...
// UseragentParser SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class UseragentParserMakeRequest
{
    public static function call(UseragentParserContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new UseragentParserResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new UseragentParserResponse($fetched);
        } else {
