...
// UseragentParser SDK utility: graphql
//
...
class UseragentParserGraphql
{
    ...
    // equivalent.
    public static function body(UseragentParserContext $ctx): mixed
    {
    ...
    public static function errors(UseragentParserContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
