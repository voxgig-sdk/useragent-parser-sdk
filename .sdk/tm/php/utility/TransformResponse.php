...
// UseragentParser SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class UseragentParserTransformResponse
{
    public static function call(UseragentParserContext $ctx): mixed
    {
        ...
        $transform = UseragentParserHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
