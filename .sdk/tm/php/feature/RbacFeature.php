...
// UseragentParser SDK rbac feature
...
class UseragentParserRbacFeature extends UseragentParserBaseFeature
{
    ...
    private function _required(UseragentParserContext $ctx): ?string
    {
    ...
    private function _reject(UseragentParserContext $ctx, string $required): void
    {
    ...
    private function _track(UseragentParserContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
