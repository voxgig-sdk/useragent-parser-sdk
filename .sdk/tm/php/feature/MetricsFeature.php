...
// UseragentParser SDK metrics feature
...
class UseragentParserMetricsFeature extends UseragentParserBaseFeature
{
    ...
    private function _record(UseragentParserContext $ctx, bool $ok): void
    {
