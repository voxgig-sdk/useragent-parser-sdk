...
// UseragentParser SDK audit feature
...
class UseragentParserAuditFeature extends UseragentParserBaseFeature
{
    ...
    private function _emit(UseragentParserContext $ctx, string $outcome): void
    {
