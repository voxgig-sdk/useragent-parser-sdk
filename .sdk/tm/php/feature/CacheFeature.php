...
// UseragentParser SDK cache feature
...
class UseragentParserCacheFeature extends UseragentParserBaseFeature
{
    ...
    private function _through(UseragentParserContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
