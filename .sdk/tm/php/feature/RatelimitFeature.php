...
// UseragentParser SDK ratelimit feature
...
class UseragentParserRatelimitFeature extends UseragentParserBaseFeature
{
    ...
    private function _acquire(UseragentParserContext $ctx): void
    {
    ...
    private function _track(UseragentParserContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
