# UseragentParser Ruby SDK Reference

Complete API reference for the UseragentParser Ruby SDK.
...
#### `UseragentParserSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
result, err = client.Parse.load({ "id" => "parse_id" })
```
