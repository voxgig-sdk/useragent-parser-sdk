...
#      offline in seeded test mode (UseragentParserSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "UseragentParser_sdk.rb")
  SDK_CLASS = "UseragentParserSDK"
