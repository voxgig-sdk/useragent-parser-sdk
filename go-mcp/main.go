// Command UseragentParser-mcp is an MCP server exposing the UseragentParser
// SDK as MCP tools.
//
// Two tools are registered:
//
//	UseragentParser_list  — list records of an entity
//	UseragentParser_load  — load a single record of an entity
//
