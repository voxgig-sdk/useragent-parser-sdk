...
type Args struct {
	Entity string         `json:"entity" jsonschema:"parse"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.UseragentParserSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "useragent-parser_list",
		Description: "List records from UseragentParser. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "useragent-parser_load",
		Description: "Load a single record from UseragentParser. " +
...
func runOp(client *sdk.UseragentParserSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UseragentParserSDK, name string) (sdk.UseragentParserEntity, error) {
	switch strings.ToLower(name) {
	case "parse":
		return client.Parse(nil), nil
