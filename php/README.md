# UseragentParser PHP SDK

The PHP SDK for the UseragentParser API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Parse(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->UseragentParser(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── useragentparser_sdk.php          -- Main SDK class
...
The main class (`useragentparser_sdk.php`) exports the SDK class
