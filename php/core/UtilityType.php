...
// UseragentParser SDK utility type

class UseragentParserUtility
{
    ...
    public static function copy(UseragentParserUtility $src): UseragentParserUtility
    {
        $u = new UseragentParserUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
