...
// UseragentParser SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UseragentParserSDK::test)
...
{
    private const SDK_CLASS = 'UseragentParserSDK';
    ...
    private const SDK_BASE = 'useragentparser_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../useragentparser_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
