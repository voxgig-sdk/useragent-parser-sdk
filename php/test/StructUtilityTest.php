...
// UseragentParser SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UseragentParserOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UseragentParserOmni::structfix($now, Struct::undef()))
                        !== json_encode(UseragentParserOmni::structfix($val, Struct::undef()))) {
