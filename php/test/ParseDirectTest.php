...
class ParseDirectTest extends TestCase
{
    public function test_direct_load_parse(): void
    {
        $setup = parse_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-parse", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
