...
// UseragentParser SDK utility: make_options

class UseragentParserMakeOptions
{
    ...
    public static function call(UseragentParserContext $ctx): array
    {
        ...
        //
        // `UseragentParserSchema::optspec()` is built from the model:
        ...
        $optspec = UseragentParserSchema::optspec();
