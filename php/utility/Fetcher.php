...
// UseragentParser SDK utility: fetcher

class UseragentParserFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UseragentParserSDK/1.0)';
    ...
    public static function call(UseragentParserContext $ctx, string $fullurl, array $fetchdef): array
    {
