...
// UseragentParser SDK utility: result_basic

class UseragentParserResultBasic
{
    public static function call(UseragentParserContext $ctx): ?UseragentParserResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof UseragentParserError) ? $result->err->msg : (string)$result->err;
