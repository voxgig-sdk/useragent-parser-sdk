...
// UseragentParser SDK timeout feature
...
class UseragentParserTimeoutFeature extends UseragentParserBaseFeature
{
    ...
    private function _with_timeout(UseragentParserContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UseragentParserContext $_ctx, float $ms): void
    {
        $client = $this->client;
