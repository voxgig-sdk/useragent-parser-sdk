...
// UseragentParser SDK clienttrack feature
...
class UseragentParserClienttrackFeature extends UseragentParserBaseFeature
{
    ...
    public function PostConstruct(UseragentParserContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UseragentParser-SDK';
