...
// UseragentParser SDK netsim feature
...
class UseragentParserNetsimFeature extends UseragentParserBaseFeature
{
    ...
    private function _simulate(UseragentParserContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UseragentParserContext $ctx, array $applied): void
    {
        $client = $this->client;
