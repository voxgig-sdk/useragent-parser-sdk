...
// UseragentParser SDK proxy feature
...
class UseragentParserProxyFeature extends UseragentParserBaseFeature
{
    ...
    public function init(UseragentParserContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UseragentParserContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
