...
// UseragentParser SDK streaming feature
...
class UseragentParserStreamingFeature extends UseragentParserBaseFeature
{
    ...
    private function _iterate(UseragentParserResult $result): \Generator
    {
    ...
    private function _streamable(UseragentParserContext $ctx): bool
    {
