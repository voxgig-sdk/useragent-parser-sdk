...
// UseragentParser SDK debug feature
...
class UseragentParserDebugFeature extends UseragentParserBaseFeature
{
    ...
    private function _finish(UseragentParserContext $ctx, bool $ok): void
    {
