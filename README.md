...
API for parsing user agent strings, providing structured information about the client's browser, operating system, and device type.

Learn more about UserAgent Parser API at [useragent.app](https://useragent.app).
...
This SDK exposes the API as a small set of **semantic entities** — Parse — that you
