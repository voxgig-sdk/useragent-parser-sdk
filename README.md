...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/useragent-parser` | `npm install @voxgig-sdk/useragent-parser` |
| Python | `voxgig-sdk-useragent-parser` | `pip install voxgig-sdk-useragent-parser` |
| PHP | `voxgig-sdk/useragent-parser` | `composer require voxgig-sdk/useragent-parser` |
| Golang | `github.com/voxgig-sdk/useragent-parser-sdk/go` | `go get github.com/voxgig-sdk/useragent-parser-sdk/go` |
| Ruby | `voxgig-sdk-useragent-parser` | `gem install voxgig-sdk-useragent-parser` |
| Lua | `voxgig-sdk-useragent-parser` | `luarocks install voxgig-sdk-useragent-parser` |
