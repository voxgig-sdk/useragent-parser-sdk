...
func registerSDKWords(r *eng.Registry, client *sdk.UseragentParserSDK) {
...
func runOp(client *sdk.UseragentParserSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
