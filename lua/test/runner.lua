...
function runner.env_override(m)
  local live = runner.getenv("USERAGENTPARSER_TEST_LIVE")
  local override = runner.getenv("USERAGENTPARSER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("USERAGENTPARSER_TEST_EXPLAIN")
