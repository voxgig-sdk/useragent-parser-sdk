...
function runner.env_override(m)
  local live = runner.getenv("USERAGENT_PARSER_TEST_LIVE")
  local override = runner.getenv("USERAGENT_PARSER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("USERAGENT_PARSER_TEST_EXPLAIN")
