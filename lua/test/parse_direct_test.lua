...
describe("ParseDirect", function()
  it("should direct-load-parse", function()
    local setup = parse_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-parse", setup.live and "live" or "unit")
...
function parse_direct_setup(mockres)
